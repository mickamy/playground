...
type UserClient interface {
	SignUp(ctx context.Context, in *SignUpRequest, opts ...grpc.CallOption) (*SingUpResponse, error)
}
...
func (c *userClient) SignUp(ctx context.Context, in *SignUpRequest, opts ...grpc.CallOption) (*SingUpResponse, error) {
...
type UserServer interface {
	SignUp(context.Context, *SignUpRequest) (*SingUpResponse, error)
}
...
func (UnimplementedUserServer) SignUp(context.Context, *SignUpRequest) (*SingUpResponse, error) {
